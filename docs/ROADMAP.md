...
- [ ] **15.3** Implémenter la résolution de l'ancre à l'affichage : re-localiser la portion annotée dans le HTML rendu par correspondance de la citation + contexte (repli sur l'offset), et marquer l'annotation comme « détachée » si la portion n'existe plus.
