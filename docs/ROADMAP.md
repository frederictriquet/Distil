...
- [ ] **15.6** Indiquer les annotations existantes : marquer visuellement les portions annotées dans le corps de la fiche (surlignage/soulignement) et afficher un point d'entrée signalant que la fiche porte des annotations (compteur).
- [ ] **15.7** Consulter les annotations depuis la fiche : lister les annotations de la fiche (portion citée + note) et ouvrir une annotation pour la consulter.
- [ ] **15.8** Modifier et supprimer une annotation depuis sa consultation : mise à jour du texte de la note et suppression, statuts cohérents (id manquant → 404).
